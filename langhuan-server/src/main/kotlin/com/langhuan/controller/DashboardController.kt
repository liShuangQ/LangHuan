...
class DashboardController(private val dashboardService: DashboardService) {
    ...
    fun getPromptsStats(): Result<Map<String, Any>> {
    ...
    fun getFileGroupStats(): Result<Map<String, Any>> {
    ...
    fun getFileStats(): Result<Map<String, Any>> {
    ...
    fun getUserStats(): Result<Map<String, Any>> {
    ...
    fun getUsageStats(): Result<Map<String, Any>> {
