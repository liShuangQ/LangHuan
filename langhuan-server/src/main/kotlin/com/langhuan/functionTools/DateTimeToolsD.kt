...
class DateTimeToolsD {

    companion object {
        private val log = LoggerFactory.getLogger(DateTimeToolsD::class.java)
    }
...
//    resultConverter：用于将工具调用的结果转换为发送回 AI 模型的实现。有关更多详细信息，请参阅 Result Conversion。ToolCallResultConverterString object
    ...
    fun getCurrentDateTime(): String {
        ...
        return DateTimeUtils.nowWithZone().toString()
    }
...
//    required：参数是必需的还是可选的。默认情况下，所有参数都被视为必需参数。
    ...
    fun setAlarm(@ToolParam(description = "时间") time: String): String {
