...
INSERT INTO t_prompts (id, content, category, created_at, updated_at, method_name, description) VALUES (7, e'你是一个人工智能，根据用户要求回答问题。
以JSON格式返回。
确保你的回答遵循以下结构：
{
   "desc": "{回复内容}"
...
数学公式：保留LaTeX原格式
---
输出时无需不要解释，不要多余文字，只输出要求的格式，要求输出格式如下
{
  "content": ["处理后的段落内容1","处理后的段落内容2",...]
}
', 'system,prompt', '2025-03-14 16:04:35.176472', '2025-03-15 02:56:52.123748', 'llmTextSplitter', '11');
