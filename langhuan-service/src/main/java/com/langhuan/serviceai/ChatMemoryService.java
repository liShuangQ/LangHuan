...
public class ChatMemoryService {
    ...
    /** 用户聊天窗口服务 */
    @Autowired
    private TUserChatWindowService userChatWindowService;
     ...
     */
    @Autowired
    public void setChatMemoryRepository(JdbcChatMemoryRepository repository) {
        // 重新构建ChatMemory以包含仓库
        this.chatMemory = MessageWindowChatMemory.builder()
     ...
     * @return 聊天消息列表
     */
    public List<Message> getChatMemoryMessages(String id) {
