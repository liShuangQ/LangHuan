        ...
        <el-dialog title="设置" v-model="showSettingsDialog" width="70%">
            <el-form :model="settings" label-width="120px">
                ...
                <el-form-item label="AI角色提示词">
                    <div v-for="(prompt, index) in settings.aiPrompts" :key="index" class="flex items-center space-x-2">
                        ...
                        <el-input v-model="settings.aiPrompts[index]" placeholder="AI角色提示词"></el-input>
                    </div>
