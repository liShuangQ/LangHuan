...
<template>
    <aside class="flex">
        ...
        >
            ...
            <a
                href="#"
                @click.prevent="handleAction('new-chat')"
            ...
            <a
                href="#"
                @click.prevent="handleAction('barChat')"
            ...
            <a
                href="#"
                @click.prevent="handleAction('logout')"
                class="rounded-lg p-1.5 transition-colors duration-200 focus:outline-none text-slate-500 hover:bg-slate-200 dark:text-slate-400 dark:hover:bg-slate-800"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        >
            ...
            <div class="mx-2 mt-8 space-y-4">
                <form @submit.prevent>
                    <label for="search-chats" class="sr-only"
                        >Search chats</label
                    >
                    <div class="relative">
                        <input
                ...
                >
                    <div
                        class="flex-1"
                        :class="{ 'cursor-pointer': editingChatId !== chat.id }"
                        @click="
                    ...
                    <div
                        class="hidden group-hover:flex items-center space-x-1 absolute right-2"
                    >
                        <button
