...
const agentRoleGroup = ref<{ name: string; id: string }[]>([]);
// --------------个人空间相关----------------------------------------------
        ...
        <div :class="[
            ...
            <div class="px-5 space-y-5">
                ...
                <!-- <div class="space-y-2">
                    ...
                    <el-select v-model="agentRole" filterable clearable size="default" class="w-full"
                        placeholder="选择智能体角色" :disabled="isExpertMode">
                ...
                <div class="space-y-2">
                    ...
                    <el-input v-model="promptTemplate" type="textarea" size="default" :rows="3"
