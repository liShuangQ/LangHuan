...
未来将不用点击保存记录按钮，你的所有问题都会被保存。但是为了节约内存等考虑 请不要堆积过多记录，功能会在部署后体现。  <p>
添加针对对话窗口的修改名称功能  <p >
  <p style="margin-bottom: 20px;">
    对话窗口名称可以自定义，方便用户识别不同的对话。
  </p>
feat(chat): 重构聊天记忆管理服务并优化UI交互  <p>
refactor: 将聊天记忆管理逻辑从ChatService拆分到独立的ChatMemoryService  <p>
feat(chat): 在侧边栏添加聊天窗口标题编辑功能  <p>
fix(chat): 修复聊天窗口创建和消息加载的异步问题  <p>
docs: 添加对话流程图和更新README文档  <p>
style: 清理无用代码和优化代码格式  <p>
perf: 优化聊天界面性能，移除不必要的组件导入  <p>
`;
