        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600">{{ usageData.totalQuestions.toLocaleString() }}
                            </p>
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700 mb-2">历史有效回答</h3>
                            <p class="text-3xl font-bold text-purple-600">{{
                                usageData.totalValidAnswers.toLocaleString() }}</p>
                            <p class="text-sm text-gray-500 mt-1">累计有效回答次数</p>
                        </div>
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-blue-600">{{ fileGroupStats.totalCount || 0 }}</p>
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700 mb-2">历史问题反馈</h3>
                            <p class="text-3xl font-bold text-orange-600">{{ usageData.totalFeedbackCount }}</p>
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700 mb-2">历史反馈类别统计</h3>
                        </div>
                        <div class="text-green-500">
                    ...
                    <div class="mt-4 grid grid-cols-3 gap-2 text-base">
                        <div class="text-center">
                            <p class="font-semibold text-green-600">{{ usageData.feedbackTypeStats.like }}</p>
                            <p class="text-gray-500 text-sm">点赞</p>
                        </div>
                        <div class="text-center">
                            <p class="font-semibold text-red-600">{{ usageData.feedbackTypeStats.dislike }}</p>
                            <p class="text-gray-500 text-sm">点踩</p>
                        </div>
                        <div class="text-center">
                            <p class="font-semibold text-gray-600">{{ usageData.feedbackTypeStats.end }}</p>
                ...
                <div class="stats-card bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1"> 有效回答 {{ usageData.weekValidAnswers }} / 总提问 {{
                                usageData.weekQuestions }}</p>
                        </div>
                        <div class="text-blue-500">
                            <el-icon size="32">
                                <TrendCharts />
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tbody>
                                <tr v-for="(user, index) in sortedUserStats" :key="user.userId"
                                    ...
                                    <td class="px-4 py-3 text-center border-b">
                                        <span class="font-semibold text-cyan-600">{{ formatFileSize(user.weekFileSize ||
                                            0) }}</span>
                                    </td>
                                    <td class="px-4 py-3 text-center border-b">
